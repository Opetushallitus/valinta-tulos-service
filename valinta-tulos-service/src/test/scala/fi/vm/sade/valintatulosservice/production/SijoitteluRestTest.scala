...
class SijoitteluRestTest
  ...
  val hakuOidsToTest =
    Seq("1.2.246.562.29.98929669087", "1.2.246.562.29.61316288341", "1.2.246.562.29.669559278110")
  ...
  "New sijoittelu (valintarekisteri) and old sijoittelu (sijoitteluDb)" should {
    "contain same information" in {
      ...
      def compareOldAndNewSijoitteluResults(hakuOid: String) = {
        ...
        compareFields(
          uusiSijoittelu.sijoitteluajoId,
          vanhaSijoittelu.sijoitteluajoId,
          "sijoittelu.sijoitteluajoId"
        )
        ...
        compareFields(
          uusiSijoittelu.hakukohteet.size,
          vanhaSijoittelu.hakukohteet.size,
          "hakukohteet.size"
        )
        ...
        uusiSijoittelu.hakukohteet.foreach(uusiHakukohde => {
          ...
          compareFields(
            uusiHakukohde.sijoitteluajoId,
            vanhaHakukohde.sijoitteluajoId,
            "hakukohteen.sijoitteluajoId"
          )
          compareFields(uusiHakukohde.tila, vanhaHakukohde.tila, "hakukohde.tila")
          compareFields(
            uusiHakukohde.tarjoajaOid,
            None,
            "hakukohde.tarjoajaOid"
          ) // tarjoaja oids are only fetched from tarjonta on demand these days
          compareFields(
            uusiHakukohde.kaikkiJonotSijoiteltu,
            vanhaHakukohde.kaikkiJonotSijoiteltu,
            "hakukohde.kaikkiJonotSijoiteltu"
          )
          compareFields(
            uusiHakukohde.ensikertalaisuusHakijaryhmanAlimmatHyvaksytytPisteet,
            vanhaHakukohde.ensikertalaisuusHakijaryhmanAlimmatHyvaksytytPisteet,
            "hakukohde.ensikertalaisuusHakijaryhmanAlimmatHyvaksytytPisteet"
          )

          compareFields(
            uusiHakukohde.valintatapajonot.size,
            vanhaHakukohde.valintatapajonot.size,
            "hakukohde.valintatapajonot.size"
          )
          ...
          uusiHakukohde.valintatapajonot.foreach(uusiValintatapajono => {
            ...
            compareFields(
              uusiValintatapajono.tasasijasaanto,
              vanhaValintatapajono.tasasijasaanto,
              "valintatapajono.tasasijasaanto"
            )
            compareFields(
              uusiValintatapajono.tila,
              vanhaValintatapajono.tila,
              "valintatapajono.tila"
            )
            compareFields(
              uusiValintatapajono.prioriteetti,
              vanhaValintatapajono.prioriteetti,
              "valintatapajono.prioriteetti"
            )
            compareFields(
              uusiValintatapajono.aloituspaikat,
              vanhaValintatapajono.aloituspaikat,
              "valintatapajono.aloituspaikat"
            )
            compareFields(
              uusiValintatapajono.alkuperaisetAloituspaikat,
              vanhaValintatapajono.alkuperaisetAloituspaikat,
              "valintatapajono.alkuperaisetAloituspaikat"
            )
            compareFields(
              uusiValintatapajono.alinHyvaksyttyPistemaara,
              vanhaValintatapajono.alinHyvaksyttyPistemaara,
              "valintatapajono.alinHyvaksyttyPistemaara"
            )
            compareFields(
              uusiValintatapajono.eiVarasijatayttoa,
              vanhaValintatapajono.eiVarasijatayttoa,
              "valintatapajono.eiVarasijatayttoa"
            )
            compareFields(
              uusiValintatapajono.kaikkiEhdonTayttavatHyvaksytaan,
              vanhaValintatapajono.kaikkiEhdonTayttavatHyvaksytaan,
              "valintatapajono.kaikkiEhdonTayttavatHyvaksytaan"
            )
            compareFields(
              uusiValintatapajono.poissaOlevaTaytto,
              vanhaValintatapajono.poissaOlevaTaytto,
              "valintatapajono.poissaOlevaTaytto"
            )
            compareFields(
              uusiValintatapajono.hakeneet,
              vanhaValintatapajono.hakeneet,
            ...
            compareFields(
              uusiValintatapajono.varasijat,
              vanhaValintatapajono.varasijat,
              "valintatapajono.varasijat"
            )
            compareFields(
              uusiValintatapajono.varasijaTayttoPaivat,
              vanhaValintatapajono.varasijaTayttoPaivat,
              "valintatapajono.varasijaTayttoPaivat"
            )
            compareFields(
              uusiValintatapajono.varasijojaTaytetaanAsti,
              vanhaValintatapajono.varasijojaTaytetaanAsti,
              "valintatapajono.varasijojaTaytetaanAsti"
            )
            compareFields(
              uusiValintatapajono.tayttojono,
              vanhaValintatapajono.tayttojono,
              "valintatapajono.tayttojono"
            )

            compareFields(
              uusiValintatapajono.valintaesitysHyvaksytty,
              vanhaValintatapajono.valintaesitysHyvaksytty,
              "valintatapajono.valintaesitysHyvaksytty"
            )

            compareFields(
              uusiValintatapajono.hakemukset.size,
              vanhaValintatapajono.hakemukset.size,
              "valintatapajono.hakemukset.size"
            )
            ...
            uusiValintatapajono.hakemukset.foreach(uusiHakemus => {
              ...
              val vanhaHakemus = vanhaValintatapajono.hakemukset
                .find(_.hakemusOid.equals(uusiHakemus.hakemusOid))
                .get
              ...
              compareFields(
                uusiHakemus.paasyJaSoveltuvuusKokeenTulos,
                vanhaHakemus.paasyJaSoveltuvuusKokeenTulos,
                "hakemus.paasyJaSoveltuvuusKokeenTulos"
              )
              compareFields(
                uusiHakemus.prioriteetti,
                vanhaHakemus.prioriteetti,
                "hakemus.prioriteetti"
              )
              compareFields(uusiHakemus.jonosija, vanhaHakemus.jonosija, "hakemus.jonosija")
              compareFields(
                uusiHakemus.tasasijaJonosija,
                vanhaHakemus.tasasijaJonosija,
                "hakemus.tasasijaJonosija"
              )
              compareFields(uusiHakemus.tila, vanhaHakemus.tila, "hakemus.tila")
              compareFields(
                uusiHakemus.hyvaksyttyHarkinnanvaraisesti,
                vanhaHakemus.hyvaksyttyHarkinnanvaraisesti,
                "hakemus.hyvaksyttyHarkinnanvaraisesti"
              )
              compareFields(
                uusiHakemus.varasijanNumero,
                vanhaHakemus.varasijanNumero,
                "hakemus.varasijanNumero"
              )
              compareFields(
                uusiHakemus.valintatapajonoOid,
                vanhaHakemus.valintatapajonoOid,
                "hakemus.valintatapajonoOid"
              )
              compareFields(uusiHakemus.hakuOid, vanhaHakemus.hakuOid, "hakemus.hakuOid")
              compareFields(
                uusiHakemus.onkoMuuttunutViimeSijoittelussa,
                vanhaHakemus.onkoMuuttunutViimeSijoittelussa,
                "hakemus.onkoMuuttunutViimeSijoittelussa"
              )
              compareFields(
                uusiHakemus.siirtynytToisestaValintatapajonosta,
                vanhaHakemus.siirtynytToisestaValintatapajonosta,
                "hakemus.siirtynytToisestaValintatapajonosta"
              )

              debug(s"Tilankuvaukset ${uusiHakemus.tilanKuvaukset}")

              compareFields(
                uusiHakemus.tilanKuvaukset.EN,
                vanhaHakemus.tilanKuvaukset.EN,
                "hakemus.tilankuvaukset.EN"
              )
              compareFields(
                uusiHakemus.tilanKuvaukset.FI,
                vanhaHakemus.tilanKuvaukset.FI,
                "hakemus.tilankuvaukset.FI"
              )
              compareFields(
                uusiHakemus.tilanKuvaukset.SV,
                vanhaHakemus.tilanKuvaukset.SV,
                "hakemus.tilankuvaukset.SV"
              )

              compareFields(
                uusiHakemus.pistetiedot.size,
                vanhaHakemus.pistetiedot.size,
                "hakemus.pistetiedot.size"
              )
              uusiHakemus.pistetiedot.foreach(uusiPistetieto => {
                ...
                compareFields(
                  uusiPistetieto.tunniste,
                  vanhaPistetieto.tunniste,
                  "pistetieto.tunniste"
                )
                compareFields(uusiPistetieto.arvo, vanhaPistetieto.arvo, "pistetieto.arvo")
                compareFields(
                  uusiPistetieto.laskennallinenArvo,
                  vanhaPistetieto.laskennallinenArvo,
                  "pistetieto.laskennallinenArvo"
                )
                compareFields(
                  uusiPistetieto.osallistuminen,
                  vanhaPistetieto.osallistuminen,
              ...
              if (vanhaHakemus.tila.getOrElse("") != vanhaTilahistoria.last.tila) {
                info(
                  s"Vanha tilahistoria is missing latest tila entry from hakemus ${vanhaHakemus.hakemusOid}"
                )
                debug(
                  s"vanhaTilahistoria: ${vanhaHakemus.hakemusOid} / valintatapajono: ${vanhaHakemus.valintatapajonoOid} : ${vanhaTilahistoria}"
                )
                debug(
                  s"uusiTilahistoria: ${uusiHakemus.hakemusOid} / valintatapajono: ${uusiHakemus.valintatapajonoOid} : ${uusiTilahistoria}"
                )
          ...
          compareFields(
            uusiHakukohde.hakijaryhmat.size,
            vanhaHakukohde.hakijaryhmat.size,
            s"hakijaryhmat.size (hakukohde ${uusiHakukohde.oid})"
          )
          ...
          uusiHakukohde.hakijaryhmat.foreach(uusiHakijaryhma => {
            ...
            val vanhaHakijaryhma =
              vanhaHakukohde.hakijaryhmat.find(_.oid.equals(uusiHakijaryhma.oid)).get
            compareFields(
              uusiHakijaryhma.prioriteetti,
              vanhaHakijaryhma.prioriteetti,
              "hakijaryhma.prioriteetti"
            )
            ...
            compareFields(
              uusiHakijaryhma.hakukohdeOid,
              vanhaHakijaryhma.hakukohdeOid,
              "hakijaryhma.hakukohdeOid"
            )
            compareFields(uusiHakijaryhma.kiintio, vanhaHakijaryhma.kiintio, "hakijaryhma.kiintio")
            compareFields(
              uusiHakijaryhma.kaytaKaikki,
              vanhaHakijaryhma.kaytaKaikki,
              "hakijaryhma.kaytaKaikki"
            )
            compareFields(
              uusiHakijaryhma.tarkkaKiintio,
              vanhaHakijaryhma.tarkkaKiintio,
              "hakijaryhma.tarkkaKiintio"
            )
            compareFields(
              uusiHakijaryhma.kaytetaanRyhmaanKuuluvia,
              vanhaHakijaryhma.kaytetaanRyhmaanKuuluvia,
              "hakijaryhma.kaytetaanRyhmaanKuuluvia"
            )
            compareFields(
              uusiHakijaryhma.hakijaryhmatyyppikoodiUri,
              vanhaHakijaryhma.hakijaryhmatyyppikoodiUri,
              "hakijaryhma.hakijaryhmatyyppikoodiUri"
            )
            compareFields(
              uusiHakijaryhma.valintatapajonoOid,
              vanhaHakijaryhma.valintatapajonoOid,
              "hakijaryhma.valintatapajonoOid"
            )
            compareFields(
              uusiHakijaryhma.hakemusOid.size,
              vanhaHakijaryhma.hakemusOid.size,
              "hakijaryhma.hakemukset.size"
            )
            compareFields(
              uusiHakijaryhma.hakemusOid.diff(vanhaHakijaryhma.hakemusOid),
              List(),
              "hakijaryhma.hakemukset.diff"
            )
          })
        })
  ...
  private def compareTilahistoriat(
    uusiTilahistoria: List[Tilahistoria],
    vanhaTilahistoria: List[Tilahistoria]
  ) = {
  ...
  private def createVanhaSijoitteluajo(hakuOid: String) = {
    ...
    sijoitteluajo.copy(hakukohteet =
      sijoitteluajo.hakukohteet.map(h => get[Hakukohde](getHakukohde(hakuOid, h.oid)))
    )
  }

  private def getSijoitteluajo(hakuOid: String): String =
    getOld(s"$oldHost/sijoittelu-service/resources/sijoittelu/$hakuOid/sijoitteluajo/latest")
  private def getHakukohde(hakuOid: String, hakukohdeOid: String) =
    () =>
      getOld(
        s"$oldHost/sijoittelu-service/resources/sijoittelu/$hakuOid/sijoitteluajo/latest/hakukohde/$hakukohdeOid"
      )
