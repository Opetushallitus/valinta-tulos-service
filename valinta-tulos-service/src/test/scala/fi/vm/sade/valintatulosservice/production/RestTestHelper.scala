...
trait RestTestHelper {
  ...
  protected def getOld(uriString: String): String = {
    vanhaSijoitteluCasClient
      .fetch(Request(method = Method.GET, uri = createUri(uriString))) {
  ...
  protected def createUri(uriString: String): Uri =
    Uri.fromString(uriString).getOrElse(throw new RuntimeException(s"Invalid uri"))
  ...
  protected def createCasClientForOldData(target: String): Client = {
    ...
    CasAuthenticatingClient(
      casClient =
        new CasClient(casUrlOld, org.http4s.client.blaze.defaultClient, "vts-test-caller-id"),
      casParams = casParams,
  ...
  protected def getNew(url: String, vtsSessionCookie: String): String = {
    ...
    if (statusCode != 200) {
      throw new RuntimeException(
        s"Got status $statusCode from $url with headers $responseHeaders and body $result"
      )
    }
    result
  }
...
case class Hakukohde(
  ...
  ensikertalaisuusHakijaryhmanAlimmatHyvaksytytPisteet: Option[Long],
  valintatapajonot: List[Valintatapajono],
  hakijaryhmat: List[Hakijaryhma]
)

case class Hakijaryhma(
  prioriteetti: Option[Long],
  paikat: Option[Long],
  oid: String,
  nimi: Option[String],
...
case class Valintatapajono(
  tasasijasaanto: Option[String],
  tila: Option[String],
  oid: String,
  prioriteetti: Option[Long],
  aloituspaikat: Option[Long],
  alkuperaisetAloituspaikat: Option[Long],
  alinHyvaksyttyPistemaara: Option[Long],
  eiVarasijatayttoa: Option[Boolean],
  kaikkiEhdonTayttavatHyvaksytaan: Option[Boolean],
  poissaOlevaTaytto: Option[Boolean],
  valintaesitysHyvaksytty: Option[Boolean],
  hakeneet: Option[Long],
  hyvaksytty: Option[Long],
  varalla: Option[Long],
  varasijat: Option[Long],
  hakemukset: List[Hakemus],
  varasijaTayttoPaivat: Option[java.util.Date],
  varasijojaTaytetaanAsti: Option[java.util.Date],
...
case class Hakemus(
  ...
  hakemusOid: String,
  pisteet: Option[Long],
  paasyJaSoveltuvuusKokeenTulos: Option[Long],
  prioriteetti: Option[Long],
  jonosija: Option[Long],
  tasasijaJonosija: Option[Long],
  tila: Option[String],
  hyvaksyttyHarkinnanvaraisesti: Option[Boolean],
  varasijanNumero: Option[Long],
  sijoitteluajoId: Option[Long],
  hakukohdeOid: Option[String],
  tarjoajaOid: Option[String],
  valintatapajonoOid: Option[String],
...
case class Pistetieto(
  tunniste: String,
  arvo: String,
  laskennallinenArvo: String,
  osallistuminen: String,
  tyypinKoodiUri: Option[String],
  tilastoidaan: Option[Boolean]
)
...
case class Hakutoive(
  ...
  ensikertalaisuusHakijaryhmanAlimmatHyvaksytytPisteet: Option[String],
  vastaanottotieto: Option[String],
  hakutoiveenValintatapajonot: List[HakutoiveenValintatapajono]
)

case class HakutoiveenValintatapajono(
  valintatapajonoOid: String,
  valintatapajonoNimi: String,
  eiVarasijatayttoa: Option[Boolean],
  jonosija: Option[Int],
  paasyJaSoveltuvuusKokeenTulos: Option[String],
  ...
  varasijojaKaytetaanAlkaen: Option[java.util.Date],
  varasijojaTaytetaanAsti: Option[java.util.Date],
  valintatuloksenViimeisinMuutos: Option[java.util.Date],
  hakemuksenTilanViimeisinMuutos: Option[java.util.Date],
  tayttojono: Option[String],
