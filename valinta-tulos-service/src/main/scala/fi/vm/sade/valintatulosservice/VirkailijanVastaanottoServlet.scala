...
class VirkailijanVastaanottoServlet(
  ...
  override protected def applicationDescription: String =
    "Virkailijan vastaanottotietojen käsittely REST API"

  val getVastaanottoTilatByHakukohdeSwagger: OperationBuilder =
    (apiOperation[Unit]("getVastaanottoTilatByHakukohde")
  ...
  get("/haku/:hakuOid/hakukohde/:hakukohdeOid", operation(getVastaanottoTilatByHakukohdeSwagger)) {
    ...
    valintatulosService
      .hakemustenTulosByHakukohde(hakuOid, hakukohdeOid)
      .right
      .map(h =>
        Ok(
          h.map(t => {
            ...
            HakemuksenVastaanottotila(
              t.hakemusOid,
              hakutoive.map(_.valintatapajonoOid),
              hakutoive.map(_.vastaanottotila)
            )
          }).toList
        )
      ) match {
  ...
  val getValintatuloksetByHakemusSwagger: OperationBuilder =
    (apiOperation[Unit]("getValintatuloksetByHakemus")
      ...
      tags "virkailija")
  get(
    "/valintatulos/haku/:hakuOid/hakemus/:hakemusOid",
    operation(getValintatuloksetByHakemusSwagger)
  ) {
    val hakemusOid = HakemusOid(params("hakemusOid"))
    Ok(
      javaObjectToJsonString(
        valintatulosService.findValintaTuloksetForVirkailijaByHakemus(hakemusOid).asJava
      )
    )
  }

  val getValintatuloksetByHakukohdeSwagger: OperationBuilder =
    (apiOperation[Unit]("getValintatuloksetByHakukohde")
      summary "Hakee valintatulokset hakukohteen hakijoille"
      parameter pathParam[String]("hakuOid").description("Haun oid")
      parameter pathParam[String]("hakukohdeOid").description("Hakukohteen oid")
      tags "virkailija")
  get(
    "/valintatulos/haku/:hakuOid/hakukohde/:hakukohdeOid",
    operation(getValintatuloksetByHakukohdeSwagger)
  ) {
    val hakuOid = HakuOid(params("hakuOid"))
    val hakukohdeOid = HakukohdeOid(params("hakukohdeOid"))
    Ok(
      javaObjectToJsonString(
        valintatulosService.findValintaTuloksetForVirkailija(hakuOid, hakukohdeOid).asJava
      )
    )
  }

  val getValintatuloksetWithoutTilaHakijalleByHakukohdeSwagger: OperationBuilder =
    (apiOperation[Unit]("getValintatuloksetWithoutTilaHakijalleByHakukohdeSwagger")
      summary "Hakee valintatulokset hakukohteen hakijoille"
      parameter pathParam[String]("hakuOid").description("Haun oid")
      parameter pathParam[String]("hakukohdeOid").description("Hakukohteen oid")
      tags "virkailija")
  get(
    "/valintatulos/ilmanhakijantilaa/haku/:hakuOid/hakukohde/:hakukohdeOid",
    operation(getValintatuloksetWithoutTilaHakijalleByHakukohdeSwagger)
  ) {
    val hakuOid = HakuOid(params("hakuOid"))
    val hakukohdeOid = HakukohdeOid(params("hakukohdeOid"))
    Ok(
      javaObjectToJsonString(
        valintatulosService
          .findValintaTuloksetForVirkailijaWithoutTilaHakijalle(hakuOid, hakukohdeOid)
          .asJava
      )
    )
  }

  val postLatenessFlagsForApplicationsSwagger: OperationBuilder =
    (apiOperation[Set[VastaanottoAikarajaMennyt]]("getLatenessFlagsForApplicationsSwagger")
      ...
      tags "virkailija")
  post(
    "/myohastyneet/haku/:hakuOid/hakukohde/:hakukohdeOid",
    operation(postLatenessFlagsForApplicationsSwagger)
  ) {
    val hakuOid = HakuOid(params("hakuOid"))
    val hakukohdeOid = HakukohdeOid(params("hakukohdeOid"))
  ...
  val postTilaHakijalleForApplicationsSwagger: OperationBuilder =
    (apiOperation[Set[TilaHakijalle]]("postTilaHakijalleForApplicationsSwagger")
      summary "Hakee annetuille hakijoille tiedon siitä onko vastaanotto myöhässä tähän hakukohteeseen"
      parameter pathParam[String]("hakuOid").description("Haun oid")
      parameter pathParam[String]("hakukohdeOid").description("Hakukohteen oid")
  ...
  post(
    ...
    operation(postTilaHakijalleForApplicationsSwagger)
  ) {
    val hakuOid = HakuOid(params("hakuOid"))
    val hakukohdeOid = HakukohdeOid(params("hakukohdeOid"))
  ...
  val getValintatuloksetByHakuSwagger: OperationBuilder =
    (apiOperation[Unit]("getValintatuloksetByHaku")
  ...
  val getHaunKoulutuksenAlkamiskaudenVastaanototYhdenPaikanSaadoksenPiirissaSwagger
    : OperationBuilder =
    (apiOperation[List[VastaanottoRecord]](
      "getHaunKoulutuksenAlkamiskaudenVastaanototYhdenPaikanSaadoksenPiirissa"
    )
      summary "Yhden paikan säädöksen piirissä olevat vastaanotot annetun haun koulutuksen alkamiskaudella"
      parameter pathParam[String]("hakuOid").description("Haun oid")
      tags "virkailija")
  get(
    "/vastaanotot/haku/:hakuOid",
    operation(getHaunKoulutuksenAlkamiskaudenVastaanototYhdenPaikanSaadoksenPiirissaSwagger)
  ) {
    val hakuOid = HakuOid(params("hakuOid"))
    Ok(
      valintatulosService
        .haunKoulutuksenAlkamiskaudenVastaanototYhdenPaikanSaadoksenPiirissa(hakuOid)
        .toList
    )
  }
  ...
  val vastaanottoEventModel = Model(
    ...
    properties = List(
      ...
      "tila" -> ModelProperty(
        ...
        required = true,
        allowableValues = AllowableValues(Vastaanottotila.values.toList)
      ),
  ...
  val postVirkailijanVastaanottoActionsSwagger: OperationBuilder =
    (apiOperation[List[VastaanottoResult]]("postVastaanotto")
  ...
  val postTransactionalVirkailijanVastaanottoActionsSwagger: OperationBuilder =
    (apiOperation[Unit]("postVastaanotto")
      summary "Tallenna vastaanottotapahtumat transaktiossa"
      parameter bodyParam[List[VastaanottoEventDto]]
      tags "virkailija")
  post(
    "/transactional-vastaanotto",
    operation(postTransactionalVirkailijanVastaanottoActionsSwagger)
  ) {
    val vastaanottoEvents = parsedBody.extract[List[VastaanottoEventDto]]
...
case class VastaanottoResult(
  henkiloOid: String,
  hakemusOid: HakemusOid,
  hakukohdeOid: HakukohdeOid,
  result: Result
)
case class VastaanottoAikarajaMennyt(
  hakemusOid: HakemusOid,
  mennyt: Boolean,
  vastaanottoDeadline: Option[DateTime]
)
case class TilaHakijalle(
  hakemusOid: HakemusOid,
  hakukohdeOid: HakukohdeOid,
