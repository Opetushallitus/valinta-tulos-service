...
class HakutoiveentulosSerializer
    extends CustomSerializer[Hakutoiveentulos]((formats: Formats) =>
      (
        {
          case x: JObject =>
            ...
            Hakutoiveentulos(
              ...
              ilmoittautumistila =
                (x \ "ilmoittautumistila").extract[HakutoiveenIlmoittautumistila],
              ...
              viimeisinHakemuksenTilanMuutos =
                (x \ "viimeisinHakemuksenTilanMuutos").extractOpt[Date],
              viimeisinValintatuloksenMuutos =
                (x \ "viimeisinValintatuloksenMuutos").extractOpt[Date],
              ...
              ehdollisenHyvaksymisenEhtoKoodi =
                (x \ "ehdollisenHyvaksymisenEhtoKoodi").extractOpt[String],
              ehdollisenHyvaksymisenEhtoFI =
                (x \ "ehdollisenHyvaksymisenEhtoFI").extractOpt[String],
              ehdollisenHyvaksymisenEhtoSV =
                (x \ "ehdollisenHyvaksymisenEhtoSV").extractOpt[String],
              ehdollisenHyvaksymisenEhtoEN =
                (x \ "ehdollisenHyvaksymisenEhtoEN").extractOpt[String],
              ...
              jonokohtaisetTulostiedot =
                (x \ "jonokohtaisetTulostiedot").extract[List[JonokohtainenTulostieto]]
            )
        },
        {
          case tulos: Hakutoiveentulos =>
            ...
            ("hakukohdeOid" -> tulos.hakukohdeOid.toString) ~ ("hakukohdeNimi" -> tulos.hakukohdeNimi) ~
              ...
              ("viimeisinHakemuksenTilanMuutos" -> decompose(
                tulos.viimeisinHakemuksenTilanMuutos
              )) ~
              ("viimeisinValintatuloksenMuutos" -> decompose(
