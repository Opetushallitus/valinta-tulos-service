...
class VirkailijanVastaanottoActionSerializer
    extends CustomSerializer[VirkailijanVastaanottoAction]((formats: Formats) => {
      (
        {
          case json: JValue =>
            throw new UnsupportedOperationException(
              s"Deserializing ${classOf[VirkailijanVastaanottoAction].getSimpleName} not supported yet."
            )
        },
        {
...
class VastaanottoActionSerializer
    extends CustomSerializer[VastaanottoAction]((formats: Formats) => {
      (
        {
...
class IlmoittautumistilaSerializer
    extends CustomSerializer[SijoitteluajonIlmoittautumistila]((formats: Formats) => {
      (
        {
...
class ValinnantilaSerializer
    extends CustomSerializer[Valinnantila]((format: Formats) => {
      (
        {
...
class ValintatuloksenTilaSerializer
    extends CustomSerializer[ValintatuloksenTila]((_: Formats) => {
      (
        {
...
class OffsetDateTimeSerializer
    extends CustomSerializer[OffsetDateTime]((_: Formats) => {
      (
        {
          case json: JString =>
            OffsetDateTime.from(DateTimeFormatter.ISO_OFFSET_DATE_TIME.parse(json.s))
        },
        {
...
class ZonedDateTimeSerializer
    extends CustomSerializer[ZonedDateTime]((_: Formats) => {
      (
        {
          case json: JString =>
            ZonedDateTime
              .from(DateTimeFormatter.ISO_OFFSET_DATE_TIME.parse(json.s))
        ...
        },
        {
          case d: ZonedDateTime =>
            JString(
              DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(
                d.withZoneSameInstant(ZoneId.of("Europe/Helsinki"))
              )
            )
        }
      )
...
class InstantSerializer
    extends CustomSerializer[Instant]((_: Formats) => {
      (
        {
        ...
        },
        {
          case i: Instant =>
            JString(
              DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(
                i.truncatedTo(ChronoUnit.SECONDS).atZone(ZoneId.of("Europe/Helsinki"))
              )
            )
        }
      )
...
class KausiSerializer
    extends CustomSerializer[Kausi]((_: Formats) => {
      (
        {
...
class UrlSerializer
    extends CustomSerializer[URL]((_: Formats) => {
      (
        {
...
class EhdollisenHyvaksymisenEhtoSerializer
    extends CustomSerializer[EhdollisenHyvaksymisenEhto]((formats: Formats) => {
      (
        {
          case json: JObject =>
...
class LanguageKeySerializer
    extends CustomKeySerializer[Language]((_: Formats) => {
      (
        {
          case "fi" => Fi
          case "sv" => Sv
