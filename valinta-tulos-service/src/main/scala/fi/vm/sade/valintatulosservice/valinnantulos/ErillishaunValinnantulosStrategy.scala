    ...
    case (false, None) =>
      audit.log(auditInfo.user, ValinnantuloksenLisays,
        ...
        new Changes.Builder()
          ...
          .added("hyvaksyttyVarasijalta", uusi.hyvaksyttyVarasijalta.toString)
          .added("hyvaksyPeruuntunut", uusi.hyvaksyPeruuntunut.toString)
    ...
    case (true, Some(vanha)) =>
      audit.log(auditInfo.user, ValinnantuloksenPoisto,
        ...
        new Changes.Builder()
          ...
          .removed("hyvaksyttyVarasijalta", vanha.hyvaksyttyVarasijalta.toString)
          .removed("hyvaksyPeruuntunut", vanha.hyvaksyPeruuntunut.toString)
