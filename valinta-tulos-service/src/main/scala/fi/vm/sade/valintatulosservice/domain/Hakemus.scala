...
case class Henkilotiedot(kutsumanimi: Option[String], email: Option[String], hasHetu: Boolean, kansalaisuudet: List[String], yksiloity: Option[Boolean] = None, yksiloityVTJ: Option[Boolean] = None, yksiloityEidas: Option[Boolean] = None)
