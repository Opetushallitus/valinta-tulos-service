...
trait ValinnantulosRepositoryImpl extends ValinnantulosRepository with ValintarekisteriRepository {
  ...
  override def getViimeisinValinnantilaMuutosHistoriasta(hakemusOid: HakemusOid, hakukohdeOid: HakukohdeOid, valintatapajonoOid: ValintatapajonoOid): Option[Valinnantila] = {
