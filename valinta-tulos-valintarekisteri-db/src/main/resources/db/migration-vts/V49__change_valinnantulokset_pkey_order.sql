alter table viestinnan_ohjaus drop constraint if exists viestinnan_ohjaus_hakukohde_oid_fkey;
alter table viestinnan_ohjaus drop constraint if exists viestinnan_ohjaus_hakukohde_oid_valintatapajono_oid_hakemu_fkey;
